...
<body>
    ...
    <p><strong>Rating Atual:</strong> <?php echo $playerData['a_rating_atual'] . getProfileStatus($playerId); ?></p>
            ...
            <table>
                ...
                <tbody>
                    ...
                    while ($row = $historicoResult->fetch_assoc()) {
                        echo "<tr>";
                        echo "<td><span>" . $row['a_index'] . "</span></td>";
                        echo "<td onclick='redirectToProfile(" . $row['a_desafiado'] . ")'><span style='color: " . $_cor_desafiado . ";'>" . obterNomeJogador($row['a_desafiado']) ." (".$row['a_desafiado_rating'].")" . ($row['a_resultado'] !== null ? ' ' . getStatus($row['a_index'],$row['a_desafiado'], true) : '') . "</span></td>";
                        echo "<td onclick='redirectToProfile(" . $row['a_desafiante']. ")'><span style='color: " . $_cor_desafiante . ";'>" . obterNomeJogador($row['a_desafiante']) ." (".$row['a_desafiante_rating'].")" . ($row['a_resultado'] !== null ? ' ' . getStatus($row['a_index'],$row['a_desafiante'], true) : '') . "</span></td>";
                        echo "<td><span>" . date('d/m/Y', strtotime($row['a_data'])) . "</span></td>";
